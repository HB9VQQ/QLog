                                                  ...
                                                  QString &submode) const
{
    ...
    case RIG_MODE_PKTLSB: { if (isSmartSDRSlice(rig->caps) || QString::fromLatin1(rig->caps->mfg_name).contains("flex", Qt::CaseInsensitive)) return "RTTY"; submode = "LSB"; return "SSB";}
